...
document.querySelectorAll('.nav-btn').forEach(b=>b.onclick=()=>{nav(b.dataset.view);if(b.dataset.view==='shelf')renderShelf();if(b.dataset.view==='chat')renderChat();if(b.dataset.view==='community')renderCommunity();if(b.dataset.view==='friends')window.TongpinFriends?.refresh()});$('home-open-create')?.addEventListener('click',()=>$('open-create')?.click());$('home-open-board')?.addEventListener('click',()=>nav('board'));
read();
